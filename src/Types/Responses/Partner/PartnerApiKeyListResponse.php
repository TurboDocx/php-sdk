...
/**
 * Response from listing partner API keys
 */
final class PartnerApiKeyListResponse implements \JsonSerializable
{
    /**
     * @param bool $success
     * @param array<PartnerApiKey> $results
    ...
    public static function fromArray(array $data): self
    {
        ...
        $results = array_map(
            fn(array $key) => PartnerApiKey::fromArray($key),
    ...
    public function toArray(): array
    {
        return [
            ...
            'data' => [
                'results' => array_map(fn(PartnerApiKey $key) => $key->toArray(), $this->results),
