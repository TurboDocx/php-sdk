...
/**
 * Response from listing organization API keys
 */
final class OrgApiKeyListResponse implements \JsonSerializable
{
    /**
     * @param bool $success
     * @param array<OrgApiKey> $results
    ...
    public static function fromArray(array $data): self
    {
        ...
        $results = array_map(
            fn(array $key) => OrgApiKey::fromArray($key),
    ...
    public function toArray(): array
    {
        return [
            ...
            'data' => [
                'results' => array_map(fn(OrgApiKey $key) => $key->toArray(), $this->results),
