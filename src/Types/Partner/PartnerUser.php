...
/**
 * Partner user domain type
 */
final class PartnerUser implements \JsonSerializable
{
    public function __construct(
        ...
        public readonly ?bool $isPrimaryAdmin = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            role: $data['role'] ?? null,
            permissions: isset($data['permissions']) ? PartnerPermissions::fromArray($data['permissions']) : null,
            isPrimaryAdmin: isset($data['isPrimaryAdmin']) ? (bool) $data['isPrimaryAdmin'] : null,
